{ stdenv, fetchFromGitHub, autoreconfHook, pkgconfig, gtk_doc, libxslt, docbook_xsl
...
in stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [
    autoreconfHook pkgconfig gtk_doc libxslt docbook_xsl python3 gobjectIntrospection
  ];
